...
import {
  ...
  resGetCandidatApply,
  resGetCandidatContract,
  resGetCandidatDisqualified,
  resGetCandidatFiltering,
  resGetCandidatNotResponding,
  resUpdateCandidatApply,
  resUpdateCandidatContract,
  resUpdateCandidatDisqualified,
  resUpdateCandidatFiltering,
  resUpdateCandidatNotResponding,
...
export function* handleUpdateCandidatFiltering(action: any): any {
  try {
    const result = yield call(
      apiMethod.updateCandidatFiltering,
      action.payload
    );
    // console.log('saga',result)
...
export function* handleUpdateCandidatDisqualified(action: any): any {
  try {
    const result = yield call(
      apiMethod.updateCandidatDisqualified,
      action.payload
    );
    // console.log('saga',result)
...
export function* handleUpdateCandidatNotResponding(action: any): any {
  try {
    const result = yield call(
      apiMethod.updateCandidatNotResponding,
      action.payload
    );
    // console.log('saga',result)
