      ...
      <div className="bg-red-400 w-full pl-10 rounded-lg">
        <div className="pt-14 pb-14 grid grid-cols-4 gap-4">
          ...
          <div className="-ml-10">
            ...
            <h3>{loadedData.program_title}, {loadedData.batch_name}, {loadedData.status_trainee}</h3>
            <h3>{format(new Date(loadedData.batch_start_date), "dd MMMM yyyy")} until {format(new Date(loadedData.batch_end_date), "dd MMMM yyyy")}</h3>
          </div>
