...
import { reqCreateSectionDetail } from "@/redux/CurriculumSchema/action/actionReducer";
const ModalSectionDetail = ({ setShowModals, data }: any) => {
  ...
  const handleRegistrationSectionDetail = async (data: any) => {
    ...
    formData.append("preview", data.secd_preview);
    ...
    formData.append("filetype", data.sedm_filetype);
    formData.append("filelink", data.sedm_filelink[0]);
    // console.log('form data', ...formData);
    dispatch(reqCreateSectionDetail(data.sect_id, formData));
    handleCancel();
  };
