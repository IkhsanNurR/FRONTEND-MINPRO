...
const Edit = () => {
  ...
  const handleRegister = async (data: FormValues) => {
    ...
    formData.append("prog_regis_id", data.prog_regis_id);
                      ...
                      <div className="grid grid-cols-2 gap-6 my-4">
                        ...
                        <div>
                          <TextField
                            ...
                            label="Learning Type"
                            defaultValue={
                              curriculumSelected?.prog_learning_type
                            }
                        ...
                        <div className="pad-input grid grid-cols-3 gap-4 w-full">
                          <div className="my-4 flex items-center gap-4 w-72">
                            ...
                            <TextField
                              ...
                              select
                              defaultValue={
                                curriculumSelected?.prog_duration_type
                              }
                      ...
                      <div className="pad-input grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <TextField
                            ...
                            defaultValue={
                              curriculumSelected?.prog_total_trainee
                            }
                  ...
                  <div className="flex flex-wrap">
                    <div className="w-full lg:w-1/2">
                      <div className="pad-input">
                        ...
                        <TextField
                          id="outlined-basic"
                          value={curriculumSelected?.prog_regis_id}
                          {...register("prog_regis_id")}
                          variant="outlined"
                          className="w-full"
                        />
                      </div>
