...
const Payment: MyPage = () => {
  let { bank, message, status, refresh } = useSelector((state: any) => state.bankReducer);
  let { fintech , refreshfintech, messagefintech, statusfintech } = useSelector((state: any) => state.fintechReducer);
  let { usersaccount, refreshaccount, messageaccount , statusaccount } = useSelector((state: any) => state.AccountReducer);
  let { transaction, refreshtransaction } = useSelector((state: any) => state.transactionReducer);
  let { topup, refreshtopup, messagetopup, statustopup } = useSelector((state: any) => state.topupReducer);
  ...
  const handleTypeChangeSource = (value: string) => {
    ...
    setIsDataComplete(!!value && !!selectedTypeTarget && !!selectedAccountNumberBank && !!selectedAccountNumberFinttech && !!saldoTransfer);
  };
  ...
  const handleRegistrationTopup = () => {
    if (!selectedTypeSource || !selectedTypeTarget || !selectedAccountNumberBank || !selectedAccountNumberFinttech || !saldoTransfer) {
      Swal.fire({
        icon: 'error',
  ...
  }, [refresh, refreshfintech, refreshaccount, refreshtopup, refreshtransaction]);
                              ...
                              <MenuItem
                                onClick={() => {
                                  router.push({
                                    ...
                                    query: {
                                      usac_user_entity_id:selected.usac_user_entity_id,
                                      usac_account_number:selected.usac_account_number,
                        ...
                        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                          ...
                          <Autocomplete
                            ...
                            onChange={(event: any, value: any) => {
                              ...
                              setSelectedAccountNumberBank(value ? value.usac_account_number : "");
                        ...
                        <div className="relative mb-4 flex w-full flex-wrap items-stretch">
                          ...
                          <Autocomplete
                            ...
                            onChange={(event: any, value: any) => {
                              ...
                              setSelectedAccountNumberFinttech(value ? value.usac_account_number : "");
